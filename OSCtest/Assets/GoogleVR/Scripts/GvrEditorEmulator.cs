...
public class GvrEditorEmulator : MonoBehaviour
{
    ...
    public void UpdateEditorEmulation()
    {
        ...
        if (CanChangeYawPitch())
        {
            ...
            mouseX += Input.GetAxis("PS4_LeftAnalogHorizontal") * 5;
            if (mouseX <= -180)
            {
                mouseX += 360;
            }
            ...
            mouseY -= Input.GetAxis("PS4_LeftAnalogVertical") * 2.4f;
    ...
    private bool CanChangeYawPitch()
    {
        ...
        return Input.GetKey(KeyCode.LeftAlt) || Input.GetKey(KeyCode.JoystickButton6);
    }
    ...
    private bool CanChangeRoll()
    {
        ...
        return Input.GetKey(KeyCode.LeftControl) || Input.GetKey(KeyCode.JoystickButton6);
    }
